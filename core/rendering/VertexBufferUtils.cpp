...
//VertexBuffer* VertexBufferUtils::CreateCone(const Vector3& d, const Vector3& a, float32 H, float32 Rd, uint32 n, BufferUsage::Enum usage)
//{
...
//	vertices.push_back({ circlePoints[0] });
//
//	return RenderContext::CreateBuffer(&vertices[0], PrimitiveType::TRIANGLE, vertices.size(), usage);
//}
