...
SamplerObject::SamplerObject(GLuint samplerID, MinFilter::Enum minFilter, MagFilter::Enum magFilter,
	TextureWrap::Enum wraps, TextureWrap::Enum wrapt) : mUID(GenSamplerObjectUID()), 
	mSamplerID(samplerID), mMinFilter(minFilter), mMagFilter(magFilter), mWrapS(wraps), mWrapT(wrapt)
{
}
